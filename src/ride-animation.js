...
function installStyles() {
  ...
  style.textContent = `
    ...
    .groomed-track{position:absolute;left:0;bottom:0;width:100%;height:100%;transform-origin:left center;transform:scaleX(0);animation:vestope-track-grow ${ANIMATION_MS}ms linear infinite;will-change:transform}
    ...
    .groomer-animation{position:absolute;left:-110px;bottom:12px;width:110px;height:70px;z-index:3;animation:vestope-groomer-drive ${ANIMATION_MS}ms linear infinite;will-change:left}
    ...
    .snow-dust{position:absolute;left:-35px;bottom:45px;width:44px;height:24px;z-index:2;opacity:0;animation:vestope-dust ${ANIMATION_MS}ms linear infinite;pointer-events:none}.snow-dust span{position:absolute;width:4px;height:4px;border-radius:50%;background:#bfd6e6}.snow-dust span:nth-child(1){left:0;top:12px}.snow-dust span:nth-child(2){left:9px;top:5px}.snow-dust span:nth-child(3){left:18px;top:15px}.snow-dust span:nth-child(4){left:28px;top:3px}.snow-dust span:nth-child(5){left:37px;top:10px}
